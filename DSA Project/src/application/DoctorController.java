...
public class DoctorController {
    ...
    // DSA: Stack for storing appointments (for demonstration purposes)
    private Stack<Appointment> appointmentStack = new Stack<>();

    // DSA: Queue for storing appointments in a FIFO manner
    private Queue<Appointment> appointmentQueue = new LinkedList<>();

    // DSA: LinkedList for storing appointments
    ...
    private void initialize() {
        ...
        // Example usage of Stack, Queue, and LinkedList:
        // Push appointments to stack
        for (Appointment appointment : appointmentsTable.getItems()) {
            appointmentStack.push(appointment);
        }

        // Enqueue appointments to queue
        for (Appointment appointment : appointmentsTable.getItems()) {
            appointmentQueue.add(appointment);
        }

        // Add appointments to LinkedList
        appointmentList.addAll(appointmentsTable.getItems());
    }
